<template>
  <div class="flex flex-col px-32 py-12 md:flex-row">
    <div class="hidden container px-6 space-y-4 py-32 md:block">
      <h1 class="text-5xl font-bold text-white uppercase">Near Printer</h1>
      <h1 class="text-3xl text-white " >
       <i>You prepare the file, we handle the rest.</i>
      </h1>
      <!-- <Button>Learn more</Button> -->
    </div>
    <div class="container flex justify-center md:justify-end">

      <form @submit.prevent="login" class="h-fit border-gray-900 border-t-2 border-b-2 space-y-6 px-6 py-6 shadow-md bg-white md:w-8/12">
