  ...
  <div class="mx-auto max-w-7xl sm:px-6 lg:px-4">
    ...
    <div class="px-4 py-4 sm:px-0">
      <div class="h-full rounded-lg border-4 border-dashed border-gray-200 px-6 py-6">
        ...
        <div v-else>
          <div v-if="stores.length" v-for="store in stores" :key="store.id" class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md">
              <a href="#">
...
export default {
  setup() {
    ...
    return { stores, loadStatus, capitalizeFirstLetter }
  }
}
</script>
<style>
