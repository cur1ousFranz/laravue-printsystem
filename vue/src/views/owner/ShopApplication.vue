<template>
  <div class="mx-auto max-w-7xl sm:px-6 lg:px-4">
    <h1 class="font-bold text-3xl text-gray-900 px-4 md:px-3">Shop Application</h1>
    <div class="overflow-x-auto relative py-6">
        ...
        <table v-else class="w-10/12 mx-auto text-sm border-gray-900 border-t-2 border-b-2 shadow-md text-left text-gray-500 dark:text-gray-400">
