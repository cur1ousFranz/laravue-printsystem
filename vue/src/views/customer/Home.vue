    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-4">
      ...
      <div class="px-4 py-4 sm:px-0">
        <div class="h-full rounded-lg border-4 border-dashed border-gray-200 px-6 py-6">
          ...
          <div v-else>
            <div v-if="shops.length" v-for="shop in shops" :key="shop.id" class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md">
                <a href="#">
                ...
                <div class="px-4 py-3">
                  ...
                  <router-link :to="{ name : 'CustomerShopView', params : { id : shop.id}}" class="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                      View
