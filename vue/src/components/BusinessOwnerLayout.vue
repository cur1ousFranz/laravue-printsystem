            ...
            <div>
              <div v-if="notifications.notifications" class="ml-4 flex items-center md:ml-6">
                ...
                <Menu v-if="notifications.notifications.length != 0" as="div" class="relative ml-3">
                  ...
                  <MenuItems>
                    <ul>
                      <li v-for="unread in notifications.unread" :key="unread.id">
                        <MenuItem  class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-green-200 py-4 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none px-3">
                    ...
                    <ul>
                      <li v-for="read in notifications.read" :key="read.id">
                        <MenuItem class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-gray-100 py-4 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none px-3">
                ...
                <Menu as="div" class="relative ml-3">
                  <div>
                    <MenuButton class="flex max-w-xs items-center rounded-full text-sm text-white px-3 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
...
const notifications = ref({})
  ...
  const navigation = [
    ...
    { name: 'Shop Report', to : { name : 'ShopReport'}},
  ]
