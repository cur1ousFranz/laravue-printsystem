      ...
      <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
                ...
                <Menu as="div" class="relative ml-3">
                  ...
                  <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
                    <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <DisclosureButton @click="logout" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-400 hover:text-white cursor-pointer">
                        Logout
                      </DisclosureButton>
                    </MenuItems>
                  </transition>
        ...
        <DisclosurePanel class="md:hidden">
          <div class="border-t border-gray-700 pt-4 pb-3">
            ...
            <DisclosureButton as="a" @click="logout" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white cursor-pointer">
              Logout
            </DisclosureButton>
            </div>
          </div>
